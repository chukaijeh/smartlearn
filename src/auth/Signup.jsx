...
function SignUp() {
  ...
  async function validate(e) {
    ...
    const [firstname, lastname, email, gender, passwd, confirmPassword] = [
      ...values,
    ];
    let condition = true;
    if (!firstname) {
    ...
    if (passwd && confirmPassword) {
      if (passwd.length < 6 || confirmPassword.length < 6) {
    ...
    if (condition) {
      ...
      res.status
        ? updateUserAccountSuccessful(res.message)
        : res.message
        ? updatePasswordError(res.message)
        : updateEmailError(res.msg);
      updateisSignUp(false);
      ...
      <div className="auth-main r-flex r-flex-column">
        <div className="bg-image main-common">
          <div className="contain-text">
            <h1>
              You're only one sign-up <br /> away from greatness!
            </h1>
        ...
        <div className="contain-form main-common">
          ...
          >
            ...
            <select name="" id="gender" className="inputfield">
